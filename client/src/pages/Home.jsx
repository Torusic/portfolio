      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <h2 className="mt-6 text-lg lg:text-xl text-gray-600 leading-relaxed max-w-xl">
            A Full Stack, ESP32 IoT Integration & Software Developer focused on building secure,
            scalable, and real-world systems using modern technologies.
          </h2>
          ...
          <div className="mt-8 flex items-center gap-6 text-gray-500">
            ...
            <a href="https://github.com/Torusic" className="flex items-center text-gray-700 hover:underline">
              <FaGithub size={26} />
            </a>

            <a href="https://www.linkedin.com/in/simon-muchuku-75b3082b6" className="flex items-center text-gray-700 hover:underline">
              <CiLinkedin size={26} />
            </a>
